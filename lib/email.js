...
const { EMAIL_DISCLAIMER } = require('./disclaimers');
...
<div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;background:#0c0e12;color:#e8e6e1;padding:32px;border-radius:8px">
  ...
  <p style="margin-top:24px;padding-top:16px;border-top:1px solid #1c2230;color:#6b7280;font-size:11px;line-height:1.5">${EMAIL_DISCLAIMER}</p>
</div>`;
}
